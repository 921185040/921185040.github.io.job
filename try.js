...
const downloadPictureList =async (list) =>{
    ...
    if (index === list.length) {
        // console.log("看看总共多少页面",pictureMessage)
        // console.log('看看是不是最后一个',lastpicture)
        // console.log('看看是不是最后一个名字',pictureName)

        // other.store(pictureName,lastpicture)
        // console.log("好像没有放进",pictureMessage[pictureName-2])
        // other.store(pictureMessage)
